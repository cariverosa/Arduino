...
void loop() {
  ...
  float ax_1  = ax*(9.81/16384.0);
  float ay_1  = ay*(9.81/16384.0);
  float az_1  = az*(9.81/16384.0);
  ...
  if (potenciometro>=4.5 && potenciometro<=5.0){
    display.setTextSize(1);
  ...
  else if (potenciometro>=4.0 && potenciometro<4.5){
    display.setTextSize(1);
    display.setCursor(0,50);
    display.print("Voltaje: ");
    display.print(float(potenciometro));
  ...
  else if (potenciometro>=3.5 && potenciometro<4.0){
    display.setTextSize(1);
    display.setCursor(0,50);
    display.print("Voltaje: ");
    display.print(float(potenciometro));
